...
export const WalletSelectorContextProvider = ({ children }: any): ReactElement => {
  ...
  if (!selector || !modal) {
    return <WalletSelectorContext.Provider value={null}>{children}</WalletSelectorContext.Provider>;
  }
